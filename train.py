...
def data_pipeline(
    ...
    if (
        ...
        # ====================================
        # CHECK FOR EACH MACHINE LEARNING TASK
        # ====================================
...
def json_to_arg_list(arg_mapping) -> List[str]:
    """Converts a dictionary of arguments to a list suitable for argparse.

    Args:
        arg_mapping (dict): Dictionary of arguments where keys are argument names and values are argument values.
